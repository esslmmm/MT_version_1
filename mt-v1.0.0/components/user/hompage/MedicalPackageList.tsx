...
const MedicalPackageList: React.FC = () => {
  ...
  return (
    <div className={`${lato.className} container mx-auto p-6 lg:px-16 pb-10 bg-green-50`}>
      <h2 className="text-3xl text-[#000000] font-black mb-2">Medical Package</h2>
      ...
      >
        <motion.div
          ...
          className="w-full sm:w-[320px] cursor-pointer bg-white rounded-2xl shadow-lg p-4 hover:shadow-2xl transition-shadow duration-300"
        >
